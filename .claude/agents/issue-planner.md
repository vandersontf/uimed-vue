...
1. Read the issue with `gh issue view <number> --comments` and any context the requester gave you. `AGENTS.md` is in your context: use its conventions and checklist as constraints.
...
5. List every decision the issue doesn't settle as a question with two or three options and your recommendation.
